...
app.get('/health', (_, res) => res.json({ ok: true, rooms: rooms.size, uptime: Math.floor(process.uptime()), version: '1.2.0' }));
...
httpServer.listen(PORT, () => {
  console.log(`🃏 Shiv's 9 Card server v1.2.0 running on port ${PORT}`);
